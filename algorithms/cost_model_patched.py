    ...
    def estimate_s(self, cm: "CostModel", node: TaskNode, dev: DeviceSpec, label: PlanLabel, ctx: PimOpContext) -> float:
        ...
        if traceable:
            try:
                ...
                # --- Shard-aware dims (TP) ---
                # Model definition may create per-shard nodes (e.g., *_s0 / *_s1).
                # Those nodes carry explicit head_dim / q_dim / kv_dim / o_dim in attrs.
                # The PIM trace generator must use them instead of assuming head_dim = dim / n_heads.
