...
OPERATOR_DEVICE_ALLOWED = {
    ...
    "SOFTMAX": {"cpu": True, "npu": True, "pima": False, "pimd": False},

    # 3) 逐元素：
    "ADD":     {"cpu": True, "npu": True, "pima": True, "pimd": True},
    "LN":      {"cpu": True, "npu": True, "pima": True, "pimd": True},
    "SWIGLU":  {"cpu": True, "npu": True, "pima": False, "pimd": False},
    "GELU":    {"cpu": True, "npu": True, "pima": False, "pimd": False},
    "ACT":     {"cpu": True, "npu": True, "pima": False, "pimd": False},
...
SCHED_JOINT_LK_GAMMA: float = 0.9
SCHED_JOINT_LK_CONSIST_LAMBDA: float = 0.5
