...
OUTPUT_ROOT="${OUTPUT_ROOT:-./output/hw_hardware_0213}"
...
HARDWARE_CONFIGS=(
  # ./src/examples/hardware_config_scale_down_4pim_merge.json
  ./src/examples/hardware_config_scale_down_11pima.json
  ./src/examples/hardware_config_scale_down_12pima.json
  # ./src/examples/hardware_config_scale_down_14pima.json
)
