...
# =========================
CONFIG_FILE="${CONFIG_FILE:-./src/examples/evaluate_len_sweep_config_npu_baseline.json}"
...
HARDWARE_CONFIGS=(
  ./src/examples/hardware_1npu.json
  # ./src/examples/hardware_1npu_2aim.json
  # ./src/examples/hardware_1npu_2aim_star.json
  # ./src/examples/hardware_1npu_4aim.json
  # ./src/examples/hardware_1npu_8aim.json
  # ./src/examples/hardware_1npu_4aim_star.json
)
...
Options:
  ...
  --hardware_glob <glob>              Override HARDWARE_CONFIGS by glob, e.g. "./src/examples/hardware_*.json"
