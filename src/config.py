...
OPERATOR_DEVICE_ALLOWED = {
    ...
    "DSV4_Q_DOWN":      {"cpu": True, "npu": True, "pim": True},
    "DSV4_Q_UP":        {"cpu": True, "npu": True, "pim": True},
    "DSV4_KV_COMPRESS": {"cpu": True, "npu": True, "pim": True},
    "DSV4_INDEX_KV_COMPRESS": {"cpu": True, "npu": True, "pim": True},
    "DSV4_WINDOW_KV":   {"cpu": True, "npu": True, "pim": True},
    "DSV4_INDEXER_Q":   {"cpu": True, "npu": True, "pim": True},
    "DSV4_INDEX_SCORE": {"cpu": True, "npu": True, "pim": True},
    "DSV4_TOPK":        {"cpu": True, "npu": True, "pim": True},
    "DSV4_O_G1":        {"cpu": True, "npu": True, "pim": True},
