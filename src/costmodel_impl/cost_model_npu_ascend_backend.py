...
_RUNTIME_DIR = os.path.join(_SRC_DIR, 'runtime_models')
...
def _candidate_mmad_lut_paths() -> list[str]:
    ...
    cand.extend([
        ...
        os.path.join(_SRC_DIR, 'mmad_lut.csv'),
        os.path.join(_SRC_DIR, 'mmad_lut.json'),
        os.path.join(_SRC_DIR, 'mmad_lookup_table.csv'),
        os.path.join(_SRC_DIR, 'mmad_lookup_table.json'),
    ])
...
def _candidate_softmax_lut_paths() -> list[str]:
    ...
    cand.extend([
        ...
        os.path.join(_SRC_DIR, 'softmax_lut.csv'),
        os.path.join(_SRC_DIR, 'softmax_lut.json'),
        os.path.join(_SRC_DIR, 'softmax_lookup_table.csv'),
        os.path.join(_SRC_DIR, 'softmax_lookup_table.json'),
    ])
...
def _candidate_gelu_lut_paths() -> list[str]:
    ...
    cand.extend([
        ...
        os.path.join(_SRC_DIR, 'gelu_lut.csv'),
        os.path.join(_SRC_DIR, 'gelu_lut.json'),
        os.path.join(_SRC_DIR, 'gelu_lookup_table.csv'),
        os.path.join(_SRC_DIR, 'gelu_lookup_table.json'),
    ])
...
def _candidate_layernorm_lut_paths() -> list[str]:
    ...
    cand.extend([
        ...
        os.path.join(_SRC_DIR, 'rmsnorm_lut.csv'),
        os.path.join(_SRC_DIR, 'rmsnorm_lut.json'),
        os.path.join(_SRC_DIR, 'layernorm_lut.csv'),
        os.path.join(_SRC_DIR, 'layernorm_lut.json'),
        os.path.join(_SRC_DIR, 'norm_lut.csv'),
        os.path.join(_SRC_DIR, 'norm_lut.json'),
        os.path.join(_SRC_DIR, 'layernorm_lookup_table.csv'),
        os.path.join(_SRC_DIR, 'layernorm_lookup_table.json'),
    ])
